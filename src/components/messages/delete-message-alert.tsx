...
export function DeleteMessageAlert({ messageId }: DeleteMessageAlertProps) {
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Esta acción no se puede deshacer. Esto eliminará permanentemente el mensaje del sistema.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
