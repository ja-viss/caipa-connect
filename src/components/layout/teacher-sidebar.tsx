...
import { LayoutDashboard, Users, Shapes, FileText, BookOpen, Send, Settings, Building } from 'lucide-react';
  ...
  return (
    <aside className="hidden md:flex flex-col w-64 bg-card border-r fixed h-full">
      <div className="flex items-center h-16 px-6 border-b">
        <Link href="/teacher/dashboard" className="flex items-center gap-2 font-semibold text-lg">
          <svg
