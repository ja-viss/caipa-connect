...
export default function Header({ isVisible }: HeaderProps) {
  ...
  return (
    <header className={cn(
        "fixed top-0 left-0 md:left-64 right-0 z-30 flex h-16 items-center gap-4 border-b bg-background/95 backdrop-blur-sm px-4 sm:px-6 transition-transform duration-300",
